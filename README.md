...
├── tests/                 # Backend test suite (639 tests across 3 tiers)
...
**Unit tests** (639 backend tests — all mocked, no external dependencies):

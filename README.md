...
├── tests/                 # Backend test suite (627 tests across 3 tiers)
...
**Unit tests** (627 backend tests — all mocked, no external dependencies):
